      ...
      case 1:
         console.log("I don't know what to do with case 1?"); // haha what
            ...
            if (name !== null & name !== "") {
                ...
                req1.open('GET', 'https://slack.com/api/chat.postMessage?token=xoxp-7213939015-8005854450-8065247734-2d7ab5&channel=%23' + channel + '&text=' + encodeURI(text) + '&username=' + encodeURI(name) + '&icon_url=' + encodeURI(imageURL) + '&pretty=1', true);
